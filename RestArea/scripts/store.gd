...
func _ready():
	...
	add_item($item01, "res://store/items/potion.png", "炸彈", [3, 3, 3], [200, 20])
	add_item($item02, "res://store/items/potion.png", "藥水", [2, 1, 1], [420, 20])
	add_item($item03, "res://store/items/potion.png", "羽毛", [0, 4, 1], [640, 20])
	add_item($item04, "res://store/items/potion.png", "蘋果", [1, 2, 0], [860, 20])
	
	var exit_button = $exit  # 這是你在場景中創建的按鈕
	exit_button.position = Vector2(1000,550)
